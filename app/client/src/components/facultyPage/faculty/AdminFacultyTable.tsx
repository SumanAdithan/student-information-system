...
export const AdminFacultyTable = ({ title, data }: AdminFacultyTableProps) => {
    ...
    return (
        <>
            ...
            {editModal.active && <AdminFacultyTableForm />}
        </>
    );
};
