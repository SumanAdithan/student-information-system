            ...
            <div>
                ...
                <div className='flex flex-col xl:flex-row xl:gap-5 rounded-2xl shadow-section xl:shadow-none mb-7'>
                    ...
                    >
                        ...
                        <div className='h-full flex flex-col items-center gap-5 divide-y divide-font-secondary mt-4 mb-4 overflow-y-scroll'>
                            <div className='flex items-center justify-between w-full px-4 text-lg font-medium'>
                                <div className=''>Subject Name</div>
                                <div>Year</div>
                            </div>
                            {subjectDetails.map((subject) => (
                                <div className='flex items-center justify-between w-full pl-4 pr-8 pb-4 text-lg font-medium'>
