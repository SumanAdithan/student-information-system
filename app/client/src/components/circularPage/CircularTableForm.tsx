...
import { Circular, CircularSchemaClient } from '@sis/types';
import { CIRCULAR_TABLE_INPUT_FIELDS as inputFields } from '@constants';
                    ...
                    >
                        {inputFields.map((input) => (
                            <InputField
                                ...
                                register={register}
                                control={control}
                                error={errors[input.name as keyof Circular]?.message as string}
                            />
                        ))}
