...
// seeder
export const addSemesterResultData = (data: SemesterResult[]) => SemesterResultModel.insertMany(data);
export const deleteSemesterResultData = () => SemesterResultModel.deleteMany();
